...
describe('Users controller integration tests', () => {
    ...
    describe('GET /api/users/:id', () => {
        ...
        it('returns 404', async () => {
            const response = await request(server).get(`/api/users/1`).set(REQUIRED_HEADERS);
            expect(response.status).toBe(404);
            expect(response.body.error_code).toEqual(404);
    ...
    describe('PUT /api/users/:id', () => {
        ...
        it('returns 415', async () => {
            ...
            const response = await request(server).put(`/api/users/2`).set(REQUIRED_HEADERS);
    ...
    describe('DELETE /api/users/:id', () => {
        ...
        it('returns 404', async () => {
            const response = await request(server).delete(`/api/users/1`).set(REQUIRED_HEADERS);
            expect(response.status).toBe(404);
            expect(response.body.error_code).toEqual(404);
            expect(response.body.message).toEqual('User not found!');
        });
